...
export default function Home() {
  ...
  const { data: _repo } = swr("https://api.github.com/users/roxza/repos");
  const repo = _repo ? _repo : null;
  const { data: _serity } = swr(
    "https://api.github.com/users/teamSerity/repos"
  );
  const serity = _serity ? _serity : null;
  return (
    <>
      {user ? (
        <>
              ...
              <>
                <div id="hero" className="p-10">
                  ...
                  <p className="text-lg leading-7 text-black dark:text-white">
                    Hello, I`m a backend developer, I`m a 16 year old high
                    school student, I`m very curious, I like to do new things, I
                    recently started learning Nuxt.JS and I make simple
                    websites, if you want to know more about me, you can check
                    page about me.
                ...
                <div className="p-10">
                  <div className="py-5 space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <Repositories repos={repo} serity={serity} />
                      {repo.length > 4 ? (
                        <>
                ...
                <div className="p-10">
                  <div className="space-y-5">
                    <h1 className="text-2xl font-bold leading-9 tracking-tight text-black dark:text-gray-100 sm:text-3xl sm:leading-10 md:text-4xl md:leading-14">
                      My <span className="text-green-500">Spotify</span> Top
                      Song
                    </h1>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
